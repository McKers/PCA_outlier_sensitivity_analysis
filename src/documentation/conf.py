...
project = "Outlier Sensitivity Analysis for Principal Component Analysis"
copyright = "2019-, Marc Kerstan"
...
latex_documents = [
    (
        ...
        """Documentation of the Outlier Sensitivity Analysis for Principal Component Analysis project""",
        "Marc Kerstan",
        "manual",
    )
]
